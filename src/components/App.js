  ...
  return (
    <div>
      <p>
        ...
        <strong>{results.length}</strong> `near misses` se cambió por `Cerdos Voladores`
      </p>
      <h2>Prueba de  Agregar texto en App.js file y tener respuesta inmediata en el navegador.</h2>
      <hr></hr>
      {results
